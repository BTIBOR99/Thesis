		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Thesis - App",
									"targetURL": "#Thesisthesis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Thesisthesis-display": {
								"semanticObject": "Thesisthesis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Thesis.thesis",
									"url": sap.ui.require.toUrl("Thesis/thesis")
								}
							}
						}
					}
