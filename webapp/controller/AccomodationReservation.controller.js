sap.ui.define(
  ...
  function (Controller, Filter, MessageBox, JSONModel, MessageToast) {
    "use strict";

    return Controller.extend(
      "Thesis.thesis.controller.AccomodationReservation",
      {
        onInit: function () {
          ...
          this.oRouter
            .getRoute("AccomodationReservation")
            .attachMatched(this.onRouteMatched, this);
        },
        onRouteMatched: function (oEvent) {
          var realid = oEvent.mParameters.arguments.Tab_index;
          var filters = new Filter({
            filters: [new Filter("Index", "EQ", realid)],
            and: true,
          });
          ...
          this.oModel.read("AccomodationSet", {
            ...
            success: function (oData) {
              this.getView()
                .byId("idAccomodationName")
                .setValue(oData.results[0].Name);
              this.getView()
                .byId("idAccomodationPlace")
                .setValue(oData.results[0].City);
              this.getView()
                .byId("idAccomodationDescription")
                .setValue(oData.results[0].Description);
              this.getView()
                .byId("idAccomodationPrice")
                .setValue(oData.results[0].Price);
              this.getView()
                .byId("idAccomodationDateFrom")
                .setValue(oData.results[0].DateFrom);
              this.getView()
                .byId("idAccomodationDateTo")
                .setValue(oData.results[0].DateTo);
              debugger;
              this.id = oData.results[0].Id;
            }.bind(this),
        ...
        staticValuesOdata: function () {
          ...
          this.getView()
            .byId("idPaymentSelect")
            .setModel(StaticModel, "StaticModel");
        },
        ...
        BillingDataValidition: function (input) {
          ...
          if (!isAlpha(this.personName)) {
            MessageBox.alert(
              "Nem tartalmazhat számot vagy speciális karaktert"
            );
          }
